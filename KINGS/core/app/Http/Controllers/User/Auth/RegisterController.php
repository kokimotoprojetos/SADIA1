    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        if(preg_match("/[^a-z0-9_]/", trim($request->username))){
            $notify[] = ['info', __('Username can contain only small letters, numbers and underscore.')];
            $notify[] = ['error', __('No special character, space or capital letters in username.')];
    ...
    public function registered(Request $request, $user)
    {
        ...
        if($general->signup_bonus_control == 1){
            ...
            $transaction->details      = __('You have got registration bonus');
            $transaction->save();
        }
