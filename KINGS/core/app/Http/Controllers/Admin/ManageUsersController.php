...
class ManageUsersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $notify[] = ['success', __('User details updated successfully')];
    ...
    public function addSubBalance(Request $request, $id)
    {
        ...
        if ($request->act == 'add') {
            ...
            $notify[] = ['success', __($general->cur_sym . $amount . ' added successfully')];

        } else {
            if ($amount > $user->$wallet) {
                $notify[] = ['error', __($user->username . ' doesn\'t have sufficient balance.')];
                return back()->withNotify($notify);
            }
            ...
            $notify[]       = ['success', __($general->cur_sym . $amount . ' subtracted successfully')];
        }
