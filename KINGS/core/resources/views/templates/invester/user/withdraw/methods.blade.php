...
<div class="head">
    ...
    <div class="head-title">{{ @lang('Withdraw') }}</div>
    <a href="{{route ('user.withdraw.history')}}" class="head-link">{{ @lang('record') }}</a>
</div>
<div class="recharge">
    ...
    <div class="recharge-head">
        ...
        <div class="recharge-main">
            <div class="recharge-tit">{{ @lang('Withdraw amount') }}</div>
        ...
        <button type="submit" class="recharge-btn">{{ @lang('Withdraw') }}</button>
