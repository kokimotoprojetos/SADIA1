...
<div class="record-list">
    <div class="product-tab">
        ...
        <a href="{{route ('user.deposit.history')}}" class="cur">{{ @lang('Recharge') }}</a>
 ...
 <ul>
     ...
     <li>
     <div class="record-dt">
     <span>{{ __($deposit->gateway?->name) }}</span>
 <span>{{ $general->cur_sym }} {{ showAmount($deposit->amount) }} </span>
 </div>
 <div class="record-dd">
     <span>{{ showDateTime($deposit->created_at, 'M d Y @g:i:a') }}</span>
 <span>  @if ($deposit->status == 1)
                                    ...
                                    @endif @php echo $deposit->statusBadge @endphp</span>
 </div>
 </li>
