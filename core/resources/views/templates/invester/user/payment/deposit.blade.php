...
<div class="head">
    ...
    <div class="head-title">{{ @lang('Recharge') }}</div>
    <a href="{{route ('user.deposit.history')}}" class="head-link">{{ @lang('record') }}</a>
</div>
<div class="recharge">
    ...
    <div class="recharge-head">
        ...
        <div class="recharge-balance">
            <span>
                {{ $general->cur_sym }} {{ showAmount(auth()->user()->deposit_wallet) }}
        ...
        <div class="recharge-main">
            <div class="recharge-tit">{{ @lang('Recharge amount') }}</div>
            <div class="recharge-amount">
                <i>{{ $general->cur_sym }}</i>

                <input type="number" placeholder="{{ @lang('please enter recharge amount') }}" step="any" name="amount"  value="{{ old('amount') }}" autocomplete="off" required>
            </div>
        </div>
        ...
        <button type="submit" class="recharge-btn">{{ @lang('Recharge') }}</button>
