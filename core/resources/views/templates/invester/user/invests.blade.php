...
<div class="record-list">
    <div class="product-tab">
        <a href="{{route ('user.invest.log')}}"  class="cur">{{ @lang('Invest') }}</a>
 ...
 <ul>
     ...
     <li>
     <div class="record-dt">
     <span>{{ __($invest->plan->name) }} - @lang('Every') {{ __($invest->time_name) }} {{ $invest->plan->interest_type != 1 ? $general->cur_sym : '' }}{{ showAmount($invest->plan->interest) }}{{ $invest->plan->interest_type == 1 ? '%' : '' }}
