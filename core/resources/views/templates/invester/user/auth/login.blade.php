...
<div class="login-form" style=" width: 100%;
    ...
    <div class="login-tab">
        ...
        <a href="{{ route('user.register') }}" class="cur">@lang('Sign Up')</a>
    </div>
    ...
    <div class="login_main">
        <div class="login_input">
            ...
            <div class="login_input_con">
                <i>+234</i>
                <input type="number" name="username" placeholder="@lang('Enter your phone number')" >
            </div>
        </div>
        ...
        <div class="login_btn">
            <button type="submit" id="submitBtn">@lang('Sign In')</button>
        </div>
    </div>
</div>
</body>
