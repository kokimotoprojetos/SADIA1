...
<div class="login-form" style=" width: 100%;
   ...
   background: #FEDC00 url(../login-bg.png) no-repeat left top/100% 100%;
    ...
    <div class="login-tab">
        <a href="{{ route('user.login') }}"  class="cur">@lang('Sign In')</a>  
    ...
    <div class="login_main">
        ...
        <div class="login_input">
            ...
            <div class="login_input_con">
                <input type="password" name="password" placeholder="@lang('please enter your password')">
            </div>
        </div>
    <span class="error" id="error_password"></span>
        ...
        <div class="login_input">
            <img src="/static/home/img/icon02.png">
            <div class="login_input_con">
                <input type="password" name="password_confirmation" placeholder="@lang('please Re enter your password')">
            </div>
        </div>
     <span class="error" id="error_confirm_password"></span>
        ...
        <div class="login_btn">
            <button type="submit" id="submitBtn">@lang('Sign Up')</button>
        </div>
    </div>
</div>
</body>
...
.login-form {
    ...
    height: 100vh;
    display: inline-block;
    background: #00927C url(../img/login-bg.png) no-repeat left top/100% 100%;
    position: relative;
    padding: 15px;
}
