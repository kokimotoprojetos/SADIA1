...
<div class="record-list">
 ...
 <ul>
     ...
     <li>
     <div class="record-dt">
     <span>{{ __(keyToTitle($transaction->remark)) }} - {{ __(keyToTitle($transaction->wallet_type)) }}</span>
 <span>{{ $general->cur_sym }} {{ showAmount($transaction->amount ) }}  </span>
 </div>
 <div class="record-dd">
     <span>{{showDateTime($transaction->created_at,'M d Y @g:i:a')}}</span>
