...
<div class="home">
            ...
            <script type="text/javascript" src="https://kingscooking.com.ng/static/home/layui/layui.js"></script> 
    ...
    <div class="home-vide">
        <img style="width:100%; height:60%;" src="../bann.jpg" id="video">
       
    </div>
    <div class="space-10"></div>
    <div class="home-notice">
        <div class="notice-con">
            <img src="/static/home/img/icon05.png">
            <div class="swiper-wrapper">
                
                                    <div class="swiper-slide">{{ __("Congratulations to 78****6717 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 75****5715 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****5388 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 87****6976 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 81****8863 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 80****5421 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 99****4357 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 72****5585 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 99****9228 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****6628 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 81****6784 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 70****3168 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****5069 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****1556 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 97****5058 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****4167 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 97****3927 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****9189 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****3902 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 72****2868 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 78****7025 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 96****9249 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****6586 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 77****9384 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****3730 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****3176 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 89****9405 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 89****1029 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 73****2452 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 96****4149 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****2173 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****1898 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 87****3021 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 93****8784 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 75****5984 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****9721 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 93****8664 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****6396 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 99****9048 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 75****5869 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 78****7614 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****9028 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 85****6432 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 76****3951 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****5316 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 97****4757 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 82****9276 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 82****3760 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 97****1752 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****5065 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 84****9130 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 78****6720 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 90****6237 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 75****9087 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 93****8840 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****5397 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****7504 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****9493 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****3425 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 81****7414 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****7575 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 80****3475 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 76****5178 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 72****1324 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 80****6448 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 87****9485 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 74****5466 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 82****8206 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 96****5255 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****5800 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****9375 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 97****4670 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 83****7207 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 77****6523 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 76****8698 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 70****1445 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 85****1583 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 86****7148 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 73****1752 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 77****3539 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 85****1069 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****2918 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 98****5198 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****9930 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 89****9730 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****8838 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 95****7593 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 70****6285 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 77****8782 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 94****4379 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 92****9535 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 87****9920 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 86****7117 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 72****1175 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 79****7880 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 88****8063 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 91****8673 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 98****8293 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 95****7975 for joining kingscooking") }}</div>
                                    <div class="swiper-slide">{{ __("Congratulations to 95****3744 for joining kingscooking") }}</div>
                            </div>
        </div>
    </div>
    <div class="space-10"></div>
        ...
        <ul>
            <li>
                <a href="{{ route('user.deposit.index') }}">
                    <img src="/static/home/img/nav01.png">
                    <span>@lang('Recharge')</span>
                </a>
            </li>
            <li>
                <a href="{{ route('user.withdraw') }}">
                    <img src="/static/home/img/nav02.png">
                    <span>@lang('Withdraw')</span>
                </a>
            </li>
            <li>
                <a href="{{ route('user.referrals') }}">
                    <img src="/static/home/img/nav03.png">
            ...
            <li>
                <a href="{{ route('plan') }}">
                    <img src="/static/home/img/nav06.png">
                    <span>@lang('My Products')</span>
                </a>
            </li>
...
<a href="https://chat.whatsapp.com/BBCobSUn1C9F8r0wGtUCaf" class="float" target="_blank">
...
;!function(e) {
    ...
    r.prototype.define = function(e, t) {
        ...
        return o && (t = e,
        e = []),
        !layui["layui.all"] && layui["layui.mobile"] ? a.call(r) : (r.use(e, a),
        r)
    }
    ,
    ...
    r.prototype.event = r.event = function(e, t, r, o) {
        ...
        return o ? (n.event[l] = n.event[l] || {},
        n.event[l][c] = [o],
        this) : (layui.each(n.event[l], function(e, t) {
            return "{*}" === c ? void layui.each(t, s) : ("" === e && layui.each(t, s),
...
.treasure-record .treasure-dd span:last-child {
    ...
    <script>
        ...
        const toastLive2 = document.getElementById('maxtoast')
    </script>
    <script>
        const toastTrigger1 = document.getElementById('liveToastBtn1')
        const toastTrigger21 = document.getElementById('maxbtn1')

        const toastTrigger11 = document.getElementById('liveToastBtn11')
        const toastTrigger211 = document.getElementById('maxbtn11')
        ...
        if (toastTrigger21) {
            toastTrigger21.addEventListener('click', () => {
        ...
        if (toastTrigger211) {
            toastTrigger211.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger23 = document.getElementById('maxbtn3')

        const toastTrigger13 = document.getElementById('liveToastBtn13')
        const toastTrigger213 = document.getElementById('maxbtn13')
        ...
        if (toastTrigger23) {
            toastTrigger23.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger13) {
            toastTrigger13.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger213) {
            toastTrigger213.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger212 = document.getElementById('maxbtn12')

        const toastTrigger112 = document.getElementById('liveToastBtn112')
        const toastTrigger2112 = document.getElementById('maxbtn112')
        ...
        if (toastTrigger212) {
            toastTrigger212.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger112) {
            toastTrigger112.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2112) {
            toastTrigger2112.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger111 = document.getElementById('liveToastBtn111')
        const toastTrigger2111 = document.getElementById('maxbtn111')
        ...
        if (toastTrigger111) {
            toastTrigger111.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2111) {
            toastTrigger2111.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger24 = document.getElementById('maxbtn4')

        const toastTrigger14 = document.getElementById('liveToastBtn14')
        const toastTrigger214 = document.getElementById('maxbtn14')
        ...
        if (toastTrigger24) {
            toastTrigger24.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger14) {
            toastTrigger14.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger214) {
            toastTrigger214.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger113 = document.getElementById('liveToastBtn113')
        const toastTrigger2113 = document.getElementById('maxbtn113')
        ...
        if (toastTrigger113) {
            toastTrigger113.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2113) {
            toastTrigger2113.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger25 = document.getElementById('maxbtn5')

        const toastTrigger15 = document.getElementById('liveToastBtn15')
        const toastTrigger215 = document.getElementById('maxbtn15')
        ...
        if (toastTrigger25) {
            toastTrigger25.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger15) {
            toastTrigger15.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger215) {
            toastTrigger215.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger114 = document.getElementById('liveToastBtn114')
        const toastTrigger2114 = document.getElementById('maxbtn114')
        ...
        if (toastTrigger114) {
            toastTrigger114.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2114) {
            toastTrigger2114.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger26 = document.getElementById('maxbtn6')

        const toastTrigger16 = document.getElementById('liveToastBtn16')
        const toastTrigger216 = document.getElementById('maxbtn16')
        ...
        if (toastTrigger26) {
            toastTrigger26.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger16) {
            toastTrigger16.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger216) {
            toastTrigger216.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger27 = document.getElementById('maxbtn7')

        const toastTrigger17 = document.getElementById('liveToastBtn17')
        const toastTrigger217 = document.getElementById('maxbtn17')
        ...
        if (toastTrigger27) {
            toastTrigger27.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger17) {
            toastTrigger17.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger217) {
            toastTrigger217.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger115 = document.getElementById('liveToastBtn115')
        const toastTrigger2115 = document.getElementById('maxbtn115')
        ...
        if (toastTrigger115) {
            toastTrigger115.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2115) {
            toastTrigger2115.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger28 = document.getElementById('maxbtn8')

        const toastTrigger18 = document.getElementById('liveToastBtn18')
        const toastTrigger218 = document.getElementById('maxbtn18')
        ...
        if (toastTrigger28) {
            toastTrigger28.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger18) {
            toastTrigger18.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger218) {
            toastTrigger218.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger29 = document.getElementById('maxbtn9')

        const toastTrigger19 = document.getElementById('liveToastBtn19')
        const toastTrigger219 = document.getElementById('maxbtn19')
        ...
        if (toastTrigger29) {
            toastTrigger29.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger19) {
            toastTrigger19.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger219) {
            toastTrigger219.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <script>
        ...
        const toastTrigger210 = document.getElementById('maxbtn10')

        const toastTrigger110 = document.getElementById('liveToastBtn110')
        const toastTrigger2110 = document.getElementById('maxbtn110')
        ...
        if (toastTrigger210) {
            toastTrigger210.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
        ...
        if (toastTrigger110) {
            toastTrigger110.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLiveExample)
        ...
        if (toastTrigger2110) {
            toastTrigger2110.addEventListener('click', () => {
                const toast = new bootstrap.Toast(toastLive2)
    ...
    <br><br><br>
    <script src="{{asset ('core/query-3.0.0.min.js')}}"></script>
    <script src="{{asset ('core/custom.js')}}"></script>
...
<script type="text/javascript">
    var _token = "zpAjDdfm9lBUoDUepCZe8jhLlQPsEHSSwWDFfg6m";
    layui.use(['form', 'layer'], function () {
        $ = layui.jquery;
        var form = layui.form, layer = layui.layer;
        //关闭通知
        $('body').on('click', '.message-btn a', function () {
            $(".z-mask").hide();
        });
        //播放视频
        $("body").on('click', '.mediaBg', function () {
            $(this).hide();
            document.getElementById("video").play();
        });
        //TAB切换
        $('body').on('click', '.product-tab a', function () {
            $(this).addClass('cur').siblings().removeClass('cur');
            $(".product-tab-con").children('.task-con').eq($(this).index()).addClass('active').siblings().removeClass('active');
        });
        $("body").on('click', '.obtain', function () {
            var _this = $(this);
            ...
            if (id.length == 0) {
                ...
                layer.msg('failed', {icon: 16, time: 1000, shade: [0.5, '#393D49']});
                return false;
            }
            $.post("https://www.coworker-ng.com/salary/done", {id: id, _token: _token}, function (result) {
                layer.close(loading);
                switch (result.code) {
                    case 200:
                    ...
                    case 201:
                        layer.msg('login invalid', {icon: 16, time: 1000, shade: [0.5, '#393D49']}, function () {
                            location.href = "https://www.coworker-ng.com/login?redirect=https%3A%2F%2Fwww.coworker-ng.com";
                        });
                        break;
                    default:
    ...
    $('.countdown').each(function (e) {
        ...
        _this.countdown(endTime, function (event) {
    ...
    var notice = new Swiper(".notice-con", {
        loop: true,
        direction: "vertical",
        grabCursor: true,
        parallax: true,
