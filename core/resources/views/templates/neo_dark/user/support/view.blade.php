            ...
            <div class="col-md-12">
                <div class="card card-bg">
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <button class="btn btn-danger btn-sm confirmationBtn w-auto" type="button" data-question="@lang('Are you sure to close this ticket?')" data-action="{{ route('ticket.close', $myTicket->id) }}"><i class="fa fa-lg fa-times-circle"></i>
                        </button>
                        @endif
                    </div>
                    <div class="card-body">
                        @if($myTicket->status != 4)
                            <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-sm btn-primary w-100"> <i class="fa fa-reply"></i> @lang('Reply')</button>
                            </form>
                        @endif
                    </div>
                </div>
