...
<script>
    (function($) {
        ...
        $('.investModal').click(function() {
            ...
            if (plan.lifetime == '0') {
                modal.find('.interestValidity').html(`<strong>  {{ __('Every') }} ${plan.time} {{ __('Hours') }},  ${plan.repeat_time} {{ __('times') }}</strong>`);
            } else {
                modal.find('.interestValidity').html(`<strong>  {{ __('Every') }} ${plan.time} {{ __('Hours') }},  {{ __('Lifetime') }} </strong>`);
            }
