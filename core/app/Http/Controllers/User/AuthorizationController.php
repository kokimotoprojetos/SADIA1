...
class AuthorizationController extends Controller
{
    ...
    public function sendVerifyCode($type)
    {
        ...
        $notify[] = ['success', __('Verification code sent successfully')];
    ...
    public function emailVerification(Request $request)
    {
        ...
        throw ValidationException::withMessages(['code' => __('Verification code didn\'t match!')]);
    }
    ...
    public function g2faVerification(Request $request)
    {
        ...
        if ($response) {
            $notify[] = ['success',__('Verification successful')];
        }else{
