...
class NotificationController extends Controller
{
    ...
    public function globalUpdate(Request $request)
    {
        ...
        $notify[] = ['success', __('Global notification settings updated successfully')];
    ...
    public function templateUpdate(Request $request, $id)
    {
        ...
        $notify[] = ['success', __('Notification template updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', __('Email settings updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function emailTest(Request $request)
    {
        ...
        $message      = __('Your email notification setting is configured successfully for ' . $general->site_name);
        ...
        if ($general->en) {
            ...
            $notify[] = ['info', __('Please enable from general settings')];
            $notify[] = ['error', __('Your email notification is disabled')];
            return back()->withNotify($notify);
        }
        ...
        if (session('mail_error')) {
            ...
            $notify[] = ['success', __('Email sent to ' . $request->email . ' successfully')];
        }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', __('Sms settings updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function smsTest(Request $request)
    {
        ...
        if ($general->sn == 1) {
            ...
            $sendSms->message      = __('Your sms notification setting is configured successfully for ' . $general->site_name);
            $sendSms->subject      = ' ';
            $sendSms->send();
        } else {
            $notify[] = ['info', __('Please enable from general settings')];
            $notify[] = ['error', __('Your sms notification is disabled')];
            return back()->withNotify($notify);
        }
        ...
        if (session('sms_error')) {
            ...
            $notify[] = ['success', __('SMS sent to ' . $request->mobile . 'successfully')];
        }
    ...
    public function pushSettingUpdate(Request $request){
        ...
        $notify[] = ['success', __('Firebase settings updated successfully')];
        return back()->withNotify($notify);
    }
