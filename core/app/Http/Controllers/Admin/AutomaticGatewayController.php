...
class AutomaticGatewayController extends Controller
{
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', __($gateway->name . ' updated successfully')];
    ...
    public function activate($code)
    {
        ...
        $gateway->status = 1;
        $gateway->save();
        $notify[] = ['success', __($gateway->name . ' enabled successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function deactivate($code)
    {
        ...
        $gateway->status = 0;
        $gateway->save();
        $notify[] = ['success', __($gateway->name . ' disabled successfully')];
        return back()->withNotify($notify);
    }
