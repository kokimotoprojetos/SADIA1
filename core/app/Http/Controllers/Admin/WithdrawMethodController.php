...
class WithdrawMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notify[] = ['success', __('Withdraw method added successfully')];
    ...
    public function activate($id)
    {
        ...
        $method->status = 1;
        $method->save();
        $notify[] = ['success', __('Withdraw method activated successfully')];
        return to_route('admin.withdraw.method.index')->withNotify($notify);
    }
    ...
    public function deactivate($id)
    {
        ...
        $method->status = 0;
        $method->save();
        $notify[] = ['success', __('Withdraw method deactivated successfully')];
        return to_route('admin.withdraw.method.index')->withNotify($notify);
    }
}
